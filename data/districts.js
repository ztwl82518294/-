 ...
 * 城市 → 区县 映射字典
 *
 * 用途：支撑「我要发货」目的地的省 → 市 → 区县 三级联动选择。
 *
 * 数据原则（硬约束）：
 *   1. 区县字典的 key 必须全部存在于 data/cities.js 的 CITIES 中（不得有字典外城市）；
 *   2. CITIES 中每个城市都必须在此处有非空区县数组（不允许跳级为空）；
 *   3. 区县名称采用**官方全称**（如「酉阳土家族苗族自治县」「石柱土家族自治县」），
 *      与民政部行政区划及政府公文保持一致，保证用户按官方名称可检索；
 *   4. 直辖市（北京/上海/天津/重庆）省级与市级同名，区县按市辖区全量列出；
 *   5. 同一城市内区县不重复。
 *
 * 覆盖范围：CITIES 中全部城市，按民政部县及以上行政区划全量收录。
 */
...
const DISTRICTS = {
  ...
  昆山: ['玉山镇', '巴城镇', '周市镇', '陆家镇', '花桥镇', '淀山湖镇', '张浦镇', '周庄镇', '千灯镇', '锦溪镇'],
  江阴: ['澄江街道', '南闸街道', '云亭街道', '申港街道', '利港街道', '夏港街道', '璜土镇', '月城镇', '青阳镇', '徐霞客镇', '华士镇', '周庄镇', '新桥镇', '长泾镇', '顾山镇', '祝塘镇'],
  常熟: ['虞山街道', '常福街道', '琴川街道', '莫城街道', '碧溪街道', '梅李镇', '海虞镇', '古里镇', '沙家浜镇', '支塘镇', '董浜镇', '尚湖镇', '辛庄镇'],
  ...
  舟山: ['定海区', '普陀区', '岱山县', '嵊泗县'],
  义乌: ['稠城街道', '北苑街道', '稠江街道', '江东街道', '后宅街道', '城西街道', '廿三里街道', '佛堂镇', '苏溪镇', '上溪镇', '大陈镇', '义亭镇', '赤岸镇'],
  慈溪: ['浒山街道', '宗汉街道', '坎墩街道', '古塘街道', '白沙路街道', '龙山镇', '掌起镇', '观海卫镇', '附海镇', '桥头镇', '匡堰镇', '逍林镇', '新浦镇', '胜山镇', '横河镇', '崇寿镇', '庵东镇', '长河镇', '周巷镇'],
  余姚: ['凤山街道', '阳明街道', '梨洲街道', '兰江街道', '朗霞街道', '低塘街道', '临山镇', '黄家埠镇', '小曹娥镇', '泗门镇', '马渚镇', '牟山镇', '丈亭镇', '三七市镇', '河姆渡镇', '大隐镇', '陆埠镇', '梁弄镇', '大岚镇', '四明山镇', '鹿亭乡'],
  诸暨: ['暨阳街道', '浣东街道', '陶朱街道', '暨南街道', '大唐街道', '应店街镇', '次坞镇', '店口镇', '姚江镇', '山下湖镇', '枫桥镇', '赵家镇', '马剑镇', '五泄镇', '牌头镇', '同山镇', '安华镇', '浬浦镇', '璜山镇', '陈宅镇', '岭北镇', '东和乡'],
  温岭: ['太平街道', '城东街道', '城西街道', '城北街道', '横峰街道', '泽国镇', '大溪镇', '箬横镇', '新河镇', '石塘镇', '滨海镇', '城南镇', '石桥头镇', '坞根镇', '松门镇', '温峤镇'],
  ...
  安庆: ['迎江区', '大观区', '宜秀区', '怀宁县', '太湖县', '宿松县', '望江县', '岳西县', '潜山市', '桐城市'],
  ...
  洛阳: ['老城区', '西工区', '瀍河回族区', '涧西区', '偃师区', '孟津区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县'],
  ...
  东莞: ['莞城街道', '南城街道', '东城街道', '万江街道', '虎门镇', '长安镇', '厚街镇', '塘厦镇', '常平镇', '松山湖'],
  佛山: ['禅城区', '南海区', '顺德区', '三水区', '高明区'],
  珠海: ['香洲区', '斗门区', '金湾区'],
  中山: ['石岐街道', '东区街道', '西区街道', '南区街道', '火炬开发区', '小榄镇', '古镇镇', '沙溪镇'],
  ...
  衡阳: ['珠晖区', '雁峰区', '石鼓区', '蒸湘区', '南岳区', '衡阳县', '衡东县', '衡山县', '衡南县', '祁东县', '耒阳市', '常宁市'],
  ...
  凉山州: ['西昌市', '会理市', '盐源县', '德昌县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县', '木里藏族自治县'],

  // ============ 重庆市（38 个区县，全量） ============
  重庆: ['渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '万州区', '涪陵区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'],
  ...
  伊春: ['伊美区', '乌翠区', '友好区', '汤旺县', '丰林县', '大箐山县', '南岔县', '金林区', '铁力市', '嘉荫县'],
  ...
  红河州: ['个旧市', '开远市', '蒙自市', '弥勒市', '屏边苗族自治县', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县'],
  ...
  那曲: ['色尼区', '比如县', '嘉黎县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '巴青县', '尼玛县', '双湖县'],
